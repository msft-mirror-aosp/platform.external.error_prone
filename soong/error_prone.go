...
func init() {
	...
	config.ErrorProneClasspath = []string{
		"external/error_prone/error_prone/error_prone_core-2.39.0-with-dependencies.jar",
		"external/error_prone/error_prone/error_prone_annotations-2.39.0.jar",
		"external/error_prone/error_prone/error_prone_type_annotations-2.39.0.jar",
